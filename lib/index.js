...
module.exports = StylusCompiler = (function() {
  ...
  StylusCompiler.prototype.compile = function(data, path, callback) {
    ...
    return this.getCompiler(data, function(compiler) {
      var defines, _ref1, _ref2, _ref3, _ref4, _ref5;

      compiler = compiler.set('filename', path).set('compress', false).set('firebug', !!((_ref1 = _this.config.plugins) != null ? (_ref2 = _ref1.stylus) != null ? _ref2.firebug : void 0 : void 0)).include(sysPath.join(_this.config.paths.root)).include(sysPath.dirname(path)).use(nib());
      if ((_ref3 = _this.config.plugins) != null ? _ref3.stylus : void 0) {
        defines = (_ref4 = _this.config.plugins.stylus.defines) != null ? _ref4 : {};
        Object.keys(defines).forEach(function(name) {
          return compiler.define(name, defines[name]);
        });
        if ((_ref5 = _this.config.plugins.stylus.paths) != null) {
          _ref5.forEach(function(path) {
